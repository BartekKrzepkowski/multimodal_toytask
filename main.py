...
def main(config):
    ...
    if config.failure_indices_path is not None:
        get_failure_indices(model, loader['train'].dataset, config.failure_indices_path)
...
if __name__ == "__main__":
    ...
    class Config:
        ...
        dataset_params = {'dataset_path': None, 'dominance_ratio': 0.7, 'is_not_ood': False}
